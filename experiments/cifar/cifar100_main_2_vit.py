...
argparse_array = ArgparseArray(
    ...
    save_path=name_instance('random_seed', 'mode', 'n_samples', 'finetune_scaling', base_folder='data/cifar_vit/main/'),
    load_path=(lambda array_id, random_seed, **kwargs: f'data/cifar_vit/pretrain/random_seed={random_seed}/model.pt'),
    model='vit'
)
